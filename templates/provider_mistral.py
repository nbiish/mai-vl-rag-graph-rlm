#!/usr/bin/env python3
"""
Mistral AI Template — Full VL-RAG-Graph-RLM Pipeline
...
def example_manual_pipeline():
    ...
    texts = [
        "Mistral AI is a European AI company based in Paris.",
        "Multilingual models excel at translation and cross-lingual understanding.",
        "The Mistral architecture uses sliding window attention for efficiency.",
    ]
    ...
    rlm = VLRAGGraphRLM(provider="mistral", temperature=0.0)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Mistral — Full VL-RAG-Graph-RLM Pipeline")
    ...
    if args.manual:
        ...
        print("Usage:")
        print("  python provider_mistral.py --input document.pptx")
        print("  python provider_mistral.py --manual")
