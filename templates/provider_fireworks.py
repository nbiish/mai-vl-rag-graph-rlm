#!/usr/bin/env python3
"""
Fireworks AI Template — Full VL-RAG-Graph-RLM Pipeline
...
def example_manual_pipeline():
    ...
    texts = [
        "Fireworks AI provides serverless inference for open-source models.",
        "Llama 3.1 70B offers strong reasoning and coding capabilities.",
        "Serverless inference eliminates the need to manage GPU infrastructure.",
    ]
    ...
    rlm = VLRAGGraphRLM(provider="fireworks", temperature=0.0)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Fireworks — Full VL-RAG-Graph-RLM Pipeline")
    ...
    if args.manual:
        ...
        print("Usage:")
        print("  python provider_fireworks.py --input document.pptx")
        print("  python provider_fireworks.py --manual")
