#!/usr/bin/env python3
"""
Google Gemini Template — Full VL-RAG-Graph-RLM Pipeline
...
def example_manual_pipeline():
    ...
    texts = [
        "Machine learning is like teaching a child through examples rather than rules.",
    ...
    rlm = VLRAGGraphRLM(provider="gemini", temperature=0.0)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Gemini — Full VL-RAG-Graph-RLM Pipeline")
    ...
    if args.manual:
        ...
        print("Usage:")
        print("  python provider_gemini.py --input document.pptx")
        print("  python provider_gemini.py --manual")
