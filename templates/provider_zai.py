#!/usr/bin/env python3
"""
z.ai (Zhipu AI) Template — Full VL-RAG-Graph-RLM Pipeline
...
def example_manual_pipeline():
    ...
    rlm = VLRAGGraphRLM(provider="zai", temperature=0.0)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="z.ai — Full VL-RAG-Graph-RLM Pipeline")
    ...
    if args.manual:
        ...
        print("Usage:")
        print("  python provider_zai.py --input document.pptx")
        print("  python provider_zai.py --manual")
